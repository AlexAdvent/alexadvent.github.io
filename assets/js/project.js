...
const projects = [
  {
    title: "Inventory Management System Using React",
    cardImage: "assets/images/project-page/inventory.png",
  ...
  {
    title: "Sard Digital Signange Software",
    cardImage: "assets/images/project-page/digital.jpg",
  ...
  {
    title: "IT's AI Online Ordering System",
    cardImage: "assets/images/project-page/online.png",
  ...
  {
    title: "Automatic Image Generator Using GAN",
    cardImage: "assets/images/project-page/gan.png",
  ...
  },
  {
    ...
    cardImage: "assets/images/project-page/yolo.png",
  ...
  {
    title: "Trading Bot",
    cardImage: "assets/images/project-page/trading.jpg",
  ...
  },
  {
    ...
    cardImage: "assets/images/project-page/prediction.jpg",
  ...
  {
    title: "Sudoku Solver",
    cardImage: "assets/images/project-page/sudoku.png",
    description:
  ...
  {
    title: "SISO Scrap Selling Website",
    cardImage: "assets/images/project-page/scrap.jpg",
  ...
  {
    title: "Automation Bot Using Python",
    cardImage: "assets/images/project-page/automation.png",
  ...
  {
    title: "Sard App Using Flutter",
    cardImage: "assets/images/project-page/sard.png",
...
const showCards = () => {
  ...
  projects.forEach(
    ({ title, cardImage, tags, Previewlink, Githublink }) => {
      (output += `       
        <div class="column column-project skill-card skill-card-project card card-project" style="margin: 15px"data-aos="zoom-in-up" data-aos-easing="linear" data-aos-delay="300" data-aos-duration="600" >
  ...
  // <ul class="menu-content-project"><br>
